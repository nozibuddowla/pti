...
const Hero = () => {
  return (
    <div className='md:py-20'>
        <div className="hero max-w-screen-xl md:bg-[#F99F1C] rounded-3xl max-w-screen-xl md:px-4 px-0 xl:h-[350px]">
            <div className="hero-content flex-col-reverse md:flex-row-reverse pb-0">
                ...
                <div className='md:p-10 p-2'>
                    ...
                    <p className="py-4 xl:text-xl lg:text-base text-sm md:text-[#f3dbb7] text-gray-600">Authentic Food, Quick Service, Fast Delivery</p>
                </div>
            </div>
        </div>
    </div>
